...
import com.cajama.malaria.encryption.MyBase64;
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
    	...
    	try {
	    	if (!dbFile.exists()) {
                ...
                Log.d(TAG, sdf.format(dbFile.lastModified()));
